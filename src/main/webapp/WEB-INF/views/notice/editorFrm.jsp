		...
		<main class="content notice-write-container">
			<section class="section notice-write-wrap">
				...
				<form action="/notice/write" method="post"
					...
					<input type="hidden" name="noticeCd" value="${noticeCd}"> <input
						type="hidden" name="noticeCdNm" value="${noticeCdNm}"> <input
						type="hidden" name="noticeWriter" value="${loginMember.memberId}">
					<%-- 현재 로그인한 사용자 == 작성자 --%>
					<table class="tbl">
						<tr>
